...
namespace Mkb.DapperRepo.Tests.Tests.GetAllByX
{
    public class GetAllByXTests : BaseSyncTestClass
    {
        public GetAllByXTests() : base($"{nameof(GetAllByXTests)}{RandomChars}")
        {
        }
        ...
        public void Ensure_we_throw_error_if_property_not_defined_correct()
        {
            var exception = Assert.Throws<Exception>(() =>
                Sut.GetAllByX<TableWithNoAutoGeneratedPrimaryKey, int>("Name", 532));
