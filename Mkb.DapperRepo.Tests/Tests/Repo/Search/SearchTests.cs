...
namespace Mkb.DapperRepo.Tests.Tests.Repo.Search
{
    public class SearchTests : BaseSyncTestClass
    {
        ...
        public void Ensure_we_can_match_exact_diff_name()
        {
            ...
            var result = Sut.Search<TableWithNoAutoGeneratedPrimaryKeyDiffSqlName>("Name", "Michael");

            Assert.AreEqual(1, result.Count());
        }

        [Test]
        public void Ensure_we_ignore_case_on_property_diff_name()
        {
            var testTableItems = new[]
            {
                new TableWithNoAutoGeneratedPrimaryKey {Id = Guid.NewGuid(), Name = "Michale", SomeNumber = 33},
        ...
        [Test]
        public void Ensure_we_can_match_ignoring_first_chars_dif_name()
        {
            var testTableItems = new[]
            {
                new TableWithNoAutoGeneratedPrimaryKey {Id = Guid.NewGuid(), Name = "Michale", SomeNumber = 33},
            ...
            var result = Sut.Search<TableWithNoAutoGeneratedPrimaryKeyDiffSqlName>("Name", "%chael");

            Assert.AreEqual(2, result.Count());
        }

        [Test]
        public void Ensure_we_can_match_ignoring_end_diff_name()
        {
            var testTableItems = new[]
            {
                new TableWithNoAutoGeneratedPrimaryKey {Id = Guid.NewGuid(), Name = "Michale", SomeNumber = 33},
            ...
            var result = Sut.Search<TableWithNoAutoGeneratedPrimaryKeyDiffSqlName>("Name", "%cha%");
