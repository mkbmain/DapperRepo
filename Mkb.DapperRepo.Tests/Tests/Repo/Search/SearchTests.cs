...
namespace Mkb.DapperRepo.Tests.Tests.Repo.Search
{
    public class SearchTests : BaseSyncTestClass
    {
        ...
        public void Ensure_we_can_match_exact()
        {
            ...
            var result = Sut.Search(new TableWithNoAutoGeneratedPrimaryKey{NameTest = "Michael"}, new SearchCriteria
            {
        ...
        {
            if (DapperRepo.Tests.Connection.SelectedEnvironment == Enviroment.PostgreSQL ||DapperRepo.Tests.Connection.SelectedEnvironment == Enviroment.Sqlite )
            {
        ...
        public void Ensure_we_can_match_like_ignoring_first_chars()
        {
            ...
            var result = Sut.Search<TableWithNoAutoGeneratedPrimaryKey>(nameof(TableWithNoAutoGeneratedPrimaryKey.NameTest), "%chael");
        ...
        public void Ensure_we_can_match_like_ignoring_end()
        {
            ...
            var result = Sut.Search<TableWithNoAutoGeneratedPrimaryKey>(nameof(TableWithNoAutoGeneratedPrimaryKey.NameTest), "%cha%");
