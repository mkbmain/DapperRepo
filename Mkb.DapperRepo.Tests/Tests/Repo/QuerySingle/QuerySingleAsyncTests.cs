...
namespace Mkb.DapperRepo.Tests.Tests.Repo.QuerySingle
{
    public class QuerySingleAsyncTests : BaseAsyncTestClass
    {
        ...
        public async Task Ensure_we_Get_correct_record_back()
        {
            ...
            {
                new TableWithNoAutoGeneratedPrimaryKey {Id = Guid.NewGuid().ToString("N"), Name = "Wanted1", SomeNumber = 11},
                new TableWithNoAutoGeneratedPrimaryKey {Id = Guid.NewGuid().ToString("N"), Name = "othername", SomeNumber = 33},
                new TableWithNoAutoGeneratedPrimaryKey {Id = Guid.NewGuid().ToString("N"), Name = "Wanted2", SomeNumber = 21}
            };
