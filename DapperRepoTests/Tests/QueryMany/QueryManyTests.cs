...
namespace DapperRepoTests.Tests.QueryMany
{
    public class QueryManyTests : BaseSyncTestClass
    {
        ...
        public void Ensure_we_Get_correct_record_back()
        {
            ...
            var items = ( Sut.QueryMany<TableWithNoAutoGeneratedPrimaryKey>("select * from TableWithNoAutoGeneratedPrimaryKey where SomeNumber = 33")).ToArray();
        ...
        {
            var items = ( Sut.QueryMany<TableWithNoAutoGeneratedPrimaryKey>("select * from TableWithNoAutoGeneratedPrimaryKey")).ToArray();
